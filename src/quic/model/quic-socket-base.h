...
namespace ns3
{
  ...
  public:
    ...
    Time m_minRtt{Seconds(99999)};           //!< The minimum RTT seen in the connection, ignoring ack delay.
  ...
  protected:
    ...
    double GetOliaAlpha(uint8_t pathId, CcType_t Olia_factor);
