...
def help(i):
    file = open(topDir+'schedulerU-0128-173'+'/scheduler'+str(i)+'-queue.txt', 'r')
    finish_time = float(file.readlines()[-2].split('\t')[0])
    file = open(topDir+'schedulerU-0128-173'+'/scheduler'+str(i)+'-rx-0128.txt', 'r')
...
route = '../results-wns3/ins_throughput_scheduler_unstable-0128.png'
