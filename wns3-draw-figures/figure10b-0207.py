...
def help(i):
    file = open(topDir+'schedulerU-0207-17'+'/scheduler'+str(i)+'-queue.txt', 'r')
    finish_time = float(file.readlines()[-2].split('\t')[0])
    file = open(topDir+'schedulerU-0207-17'+'/scheduler'+str(i)+'-rx-0207.txt', 'r')
...
route = '../results-wns3/ins_throughput_scheduler_unstable-0207.png'
