...
def draw(i):
    file = open(topDir+'scheduler-0116-2-33'+'/scheduler'+str(i)+'-queue.txt', 'r')
    finish_time = float(file.readlines()[-1].split('\t')[0])
    file = open(topDir+'scheduler-0116-2-33'+'/scheduler'+str(i)+'-rx-0116-2.txt', 'r')
    ...
    plt.savefig('../results-wns3/received_bytes_scheduler-0116'+str(i)+'.png', format='png')  
    plt.close()
