...
dataTotal = pd.DataFrame (comTime, columns = ['one', 'two', 'four', 'lte-nr-tcp'])
...
ct1 = [dataTotal['two']]
ct2 = [dataTotal['four']]
ct3 = [dataTotal['lte-nr-tcp']]
ticks = ['one', 'two', 'four', 'lte-nr-tcp']
...
define_box_properties(ct_plot3, 'orange', 'lte-nr-tcp')
...
path = "../results-wns3/scalable_comtime-lte_nr_tcp.png"
