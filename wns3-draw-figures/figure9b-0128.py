...
def help(i):
    file = open(topDir+'scheduler-0128-133'+'/scheduler'+str(i)+'-queue.txt', 'r')
    finish_time = float(file.readlines()[-4].split('\t')[0])
    file = open(topDir+'scheduler-0128-133'+'/scheduler'+str(i)+'-rx-0128.txt', 'r')
...
route = '../results-wns3/ins_throughput_scheduler-0128.png'
